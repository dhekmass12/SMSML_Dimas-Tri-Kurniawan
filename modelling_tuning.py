...
import dagshub
# dagshub.init(repo_owner='dhekmass12', repo_name='modelling_tuning', mlflow=True)


mlflow.set_tracking_uri("http://127.0.0.1:5000/")
mlflow.set_experiment("Modelling Tuning")
...
n_estimators_range = [i for i in range(20, 110, 20)]
max_depth_range = [i for i in range(20, 110, 20)]
...
for n_estimators in n_estimators_range:
    for max_depth in max_depth_range:
        with mlflow.start_run():
            ...
            mlflow.log_artifact("modelling_tuning.py", artifact_path="scripts")
